...
import xllllll.anonim.models.User;
import xllllll.anonim.models.Comment;
import xllllll.anonim.models.Post;
...
imaj = (ImageView) findViewById(R.id.imageView3);
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (downloadlink==null){
                    ...
                    imaj.setImageBitmap(decodedByte);
                } else{
                    FirebaseStorage storage = FirebaseStorage.getInstance();
                    mStorageRef = storage.getReferenceFromUrl("gs://test-c0965.appspot.com");

                    mStorageRef.child(downloadlink).getBytes(Long.MAX_VALUE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                        @Override
                        public void onSuccess(byte[] bytes) {
                            // Use the bytes to display the image
                            Bitmap bmp = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
                            imaj.setImageBitmap(bmp);
                        }
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(uid)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        PostResponseAsyncTask readTask = new PostResponseAsyncTask(PostDetailActivity.this, postData, false, new AsyncResponse() {
                            @Override
